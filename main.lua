...
-- global vars display length and height
DisplayWidth = display.contentWidth
DisplayHeight = display.contentHeight

-- global characters collection table
...
local lvlCharsTable = {}
lvlCharsTable["nessuno"] = {characters[1],characters[2]}
lvlCharsTable["medioevo"] = {characters[3],characters[3],characters[4]}
